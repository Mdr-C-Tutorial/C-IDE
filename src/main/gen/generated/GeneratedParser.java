...
public class GeneratedParser implements PsiParser, LightPsiParser {
  ...
  public static boolean enumerator(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ENUMERATOR, "<enumerator>");
    r = id(b, l + 1);
  ...
  public static boolean enumerator_list(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ENUMERATOR_LIST, "<enumerator list>");
    r = enumerator(b, l + 1);
  ...
  // digit
  //             | nondigit
  public static boolean id_continue(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "id_continue")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ID_CONTINUE, "<id continue>");
    r = digit(b, l + 1);
    if (!r) r = nondigit(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  public static boolean id_list(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ID_LIST, "<id list>");
    r = id(b, l + 1);
  ...
  /* ********************************************************** */
  // nondigit
  public static boolean id_start(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "id_start")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ID_START, "<id start>");
    r = nondigit(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  // 'return'	';'
  private static boolean jump_stat_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "jump_stat_4")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "return");
    r = r && consumeToken(b, ";");
  ...
  public static boolean nondigit(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "nondigit")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, NONDIGIT, "<nondigit>");
    r = consumeToken(b, "_");
  ...
  // '*'			pointer
  private static boolean pointer_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "pointer_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "*");
    r = r && pointer(b, l + 1);
  ...
  public static boolean typedef_name(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, TYPEDEF_NAME, "<typedef name>");
    r = id(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
